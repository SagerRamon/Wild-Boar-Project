...
All_inds <- tm_shape(underl_map) +
                tm_rgb() +
              tm_shape(Caroline) +
                tm_polygons("n", title = "Caroline (10)", alpha = 0.8, style = "cont", palette = "Blues", n = 30, popup.vars=c("Occurences:"="n")) +
              tm_shape(Miriam) +
                tm_polygons("n", title = "Miriam (22)", alpha = 0.8, style = "cont", palette = "Reds", n = 30, popup.vars=c("Occurences:"="n")) +
              tm_shape(Olga) +
                tm_polygons("n", title = "Olga (36)", alpha = 0.8, style = "cont", palette = "Greens", n = 30, popup.vars=c("Occurences:"="n")) +
              tm_shape(Franz) +
                tm_polygons("n", title = "Franz (40)", alpha = 0.8, style = "cont", palette = "Purples", n = 30, popup.vars=c("Occurences:"="n")) +
              tm_shape(Amos) +
                tm_polygons("n", title = "Amos (48)", alpha = 0.8, style = "cont", palette = "PuRd", n = 30, popup.vars=c("Occurences:"="n")) +
...
FA <- tm_shape(underl_map) +
        tm_rgb() +
        tm_shape(Franz) +
        tm_polygons("n", title = "Franz (40)", alpha = 0.8, style = "cont", palette = "Blues", n = 30, popup.vars=c("Recurrences:"="n")) +
        tm_shape(Amos) +
        tm_polygons("n", title = "Amos (48)", alpha = 0.8, style = "cont", palette = "Reds", n = 30, popup.vars=c("Recurrences:"="n")) +
...
Olga_forest <- tm_shape(underl_map) +
                  ...
                  tm_polygons("n", title = "Forest", alpha = 0.8, style = "cont", n = 30, palette = "Greens", n = 100, contrast = c(0.35, 0.9), popup.vars=c("Recurrences:"="n")) +
                  tm_borders(col = "black", lwd = 1, lty = "solid") +
                  tm_shape(agg_olga_non_forest) +
                  tm_polygons("n", title = "Not Forest", alpha = 0.8, style = "cont", n = 30, palette = "Reds", n = 100, contrast = c(0.35, 0.9), popup.vars=c("Recurrences:"="n")) +
