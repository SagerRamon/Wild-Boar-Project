...
### Function to produce an occurence plot using a grid structure. 
...
## Territorial Analysis using the "st_join" function -> keeping much more information and seems to be "the wy to go" 
