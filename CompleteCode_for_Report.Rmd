...
MO <- tm_shape(underl_map) +
        tm_rgb() +
        tm_shape(Miriam) +
        tm_polygons("n", title = "Miriam (22)", alpha = 0.8, style = "cont", palette = "Blues", n = 30, popup.vars=c("Animal ID"="TierID", "Recurrences:"="n")) +
        tm_shape(Olga) +
        tm_polygons("n", title = "Olga (36)", alpha = 0.8, style = "cont", palette = "Reds", n = 30, popup.vars=c("Animal ID"="TierID", "Recurrences:"="n")) +
